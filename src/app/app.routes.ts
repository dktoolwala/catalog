    ...
    children: [
      {
        ...
        loadComponent: () =>
          import('./pages/home-placeholder/home-placeholder.component')
            .then(m => m.HomePlaceholderComponent)
      },
      {
      ...
      },
      {
        ...
        loadComponent: () =>
          import('./pages/server-error/server-error.component')
      ...
      },
      {
        ...
        loadComponent: () =>
          import('./pages/offline/offline.component')
      ...
      },
      {
        ...
        loadComponent: () =>
          import('./pages/api-unavailable/api-unavailable.component')
            .then(m => m.ApiUnavailableComponent)
      },
      {
